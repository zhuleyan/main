...
``` java
                ...
                + "App Secret: null";
```
###### /src/test/java/seedu/address/logic/commands/LinkedInLoginCommandTest.java
``` java
...
```
###### /src/main/java/seedu/address/ui/BrowserWindow.java
``` java
...
```
###### /src/main/java/seedu/address/commons/core/Oauth2Client.java
``` java
...
```
###### /src/main/java/seedu/address/commons/events/ui/ShareToLinkedInEvent.java
``` java
...
```
###### /src/main/java/seedu/address/commons/events/ui/ShowBrowserRequestEvent.java
``` java
package seedu.address.commons.events.ui;
...
```
###### /src/main/java/seedu/address/commons/events/ui/HideBrowserRequestEvent.java
``` java
package seedu.address.commons.events.ui;
...
```
###### /src/main/java/seedu/address/logic/parser/ShareToLinkedInCommandParser.java
``` java
...
```
###### /src/main/java/seedu/address/logic/commands/ShareToLinkedInCommand.java
``` java
package seedu.address.logic.commands;
