# WoodyLau
###### /src/test/java/seedu/address/logic/commands/ConvertCommandTest.java
``` java
...
```
###### /src/main/java/seedu/address/logic/parser/EditDetailsCommandParser.java
``` java
...
```
###### /src/main/java/seedu/address/logic/parser/ConvertCommandParser.java
``` java
package seedu.address.logic.parser;
...
```
###### /src/main/java/seedu/address/logic/commands/EditDetailsCommand.java
``` java
package seedu.address.logic.commands;
...
```
###### /src/main/java/seedu/address/storage/XmlAdaptedAccount.java
``` java
...
```
###### /src/main/java/seedu/address/model/person/Type.java
``` java
...
```
###### /src/main/java/seedu/address/model/person/Contact.java
``` java
package seedu.address.model.person;
...
```
###### /src/main/java/seedu/address/model/person/Lead.java
``` java
package seedu.address.model.person;
