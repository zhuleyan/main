...
```
###### /out/production/resources/view/MainWindowLight.fxml
``` fxml
...
```
###### /out/production/resources/view/ExtensionsLight.css
``` css
.error {
...
```
###### /src/main/resources/view/MainWindowLight.fxml
``` fxml
<fx:root type="javafx.stage.Stage" xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1"
         minWidth="450" minHeight="600">
  <icons>
...
```
###### /src/main/resources/view/ExtensionsLight.css
``` css
.error {
    -fx-text-fill: #d06651 !important; /* The error class should always override the default text-fill style */
}
...
```
###### /src/main/java/seedu/address/logic/parser/ChangeThemeCommandParser.java
``` java
/**
...
```
###### /src/main/java/seedu/address/logic/commands/ChangeThemeCommand.java
``` java
/**
...
```
###### /src/main/java/seedu/address/model/Theme.java
``` java
/**
...
```
###### /src/main/java/seedu/address/model/Exception/InputThemeEqualsCurrentThemeException.java
``` java
/**
