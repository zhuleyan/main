...
* In v 1.3: Introduce calander for meetings. Able to detect a duplicate based on a phone number. Able to fully authenticate linkedIn, and link contacts to linkedIn. At least two alias commands will be completed. Auto-Complete of commands enabled.
