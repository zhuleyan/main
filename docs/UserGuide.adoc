...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. Able to do some smart deduplication detection. Completion of edit command alias. Able to start process of LinkedIn Integration

* In v 1.3: Introduce calander for meetings. Smarter deduplication detection. Able to fully authenticate linkedIn, and link contacts to linkedIn. At least two alias commands will be completed.

* In v 1.4: Able to book meetings using the calander. Deduplication becomes even smarter. CRM Book will alert you if a contact switches companies. At least two alias commands will be completed.

* In v 1.5: All commands can be performed with its alias.
...
=== Editing a person : `e or edit`

Edits an existing person in the address book. +
Format: `e INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...` or `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...`
...
=== Converting a person : `convert`

Converts an existing Lead in the address book. +
Format: `convert INDEX`
...
* `convert 2` +
Converts the second person in the list to a Contact.

=== Locating persons by name: `f or find` [in progress]
...
* *Clear* : `c` or `clear`
* *Delete* : `d INDEX` or `delete INDEX` +
e.g. `d 5`, `delete 3`
* *Edit* : `e INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` or `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
