...
image::RemarkCommandDiagram.png[width="800"]
...
=== Identifying a Duplicate Lead feature [Planning to add]
...
The phone number and email address of a lead will be checked in two respective hash sets.
If any of these hash sets contain either the phone number of email address of a lead,
...
* **Alternative 1 (current choice):** Save the phone numbers of all leads in in a hashset.
** Pros: Search will be performed in constant time.
** Cons: Nil.
* **Alternative 2:** Save the phone numbers of all leads in in a list.
** Pros: Phone numbers can be arranged in a certain order.
** Cons: Search will be performed in linear time, which is longer than constant time.
...
2.  CRM opens the corresponding CSV file.
3.  CRM processes data and lists all persons including newly added ones.
+
Use case ends.
