...
<<../UserGuide.adoc#321-add-or-remove-a-remark-to-a-lead-or-contact-rem-remark--since-v12, Remark Command>>

<<../UserGuide.adoc#322-sort-persons-by-name-in-alphabetical-order-st-sort--since-v13, Sort Command>>
...
<<../DeveloperGuide.adoc#remark-feature, Remark Command>>

<<../DeveloperGuide.adoc#bulk-import-feature, Import Command>>
